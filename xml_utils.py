...
def createXML(jpg_file, boxes, img_size,cls):
...
def createXMLAnnotation(jpg_file, boxes, img_size, filename_xml,cls):
    xml = createXML(jpg_file, boxes, img_size,str(cls))
